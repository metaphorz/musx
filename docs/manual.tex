...
releases cleanly, plus the same Start-Mod jitter for stacking. Crucially, because it is driven by
...
chord. The remaining demos are \textbf{XY Synth} (Figure~\ref{fig:interface}),
\textbf{FuncGen $\rightarrow$ Plot} (Figure~\ref{fig:funcgen-plot}), \textbf{Keyboard Synth}, and
\textbf{Bang + Code} (Figure~\ref{fig:bang-code}).
