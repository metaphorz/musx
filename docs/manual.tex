...
synth    & \texttt{osc\~{}}   & Oscillator (sine/square/saw/triangle); freq control + audio-rate FM inlet \\
         ...
         & \texttt{adsr\~{}}  & Attack--decay--sustain--release amplitude envelope (gated note-on/off for held sustain) \\
...
Seven demos ship with MusX. Two reproduce examples from the Max/MSP product
...
transposable chord (Section~\ref{sec:richsound}). The remaining demos are
