...
first eight-bar phrase of the Silo violin line, decoded from its MIDI file with the exact timing and
velocities, so the roll plays a real melody with dynamics out of the box.
